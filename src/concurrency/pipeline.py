...
async def register_item(
    ...
    2. Save image to disk with UUID filename
    3. Write to DB (image_path included)
    ...
    # 2. Save image with UUID filename (path traversal safe)
    ...
    #    Run them CONCURRENTLY — this is the main speedup
...
async def find_matches(
    ...
    """
    # Raises ItemNotFound if missing — api.py will catch it
